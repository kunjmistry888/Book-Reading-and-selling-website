...
if(isset($_POST['add_product'])){
   ...
   if (isset($_POST['submit'])) {
      ...
      $select_pdf_file = mysqli_query($conn, "INSERT INTO products(pdf) VALUES('$pdf')") or die('query failed');
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" min="0" name="price" class="box" placeholder="enter product price" required><br><br>
      <h3 style="text-align:left">Choose image</h3>
      <input type="file" name="image" accept="image/jpg, image/jpeg, image/png" class="box" required><br><br>
      <!--<h3 style="text-align:left">Choose pdf file</h3>
      <input id="pdf" type="file" name="pdf" value="" class="box" required><br><br>-->
